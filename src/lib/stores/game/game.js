  ...
  return {
    ...
    move: position => {
      update(game => {
        ...
        return {
          ...game, // Spread the original game state to retain its current 'future' etc.
          future: [], // Clear future on new move, as per existing logic
          history: newHistory, // Set the updated history
    ...
    placeHorizontalFence: position => {
      update(game => {
        ...
        return {
          ...game,
          future: [], // Clear future on new move
          history: newHistory,
          fences: {
            positions: {
