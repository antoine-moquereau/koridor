...
describe('Game Store - History, Undo, Redo', () => {
  ...
  describe('Undo Functionality', () => {
    it('should undo moves correctly and manage history/future arrays', () => {
      ...
      const {
        ...
        future: _f1,
        ...stateAfterMove1
      } = JSON.parse(JSON.stringify(get(game)))
      ...
      const {
        history: _hBeforeUndo,
        future: _fBeforeUndo,
        ...stateBeforeExtraUndo
      } = JSON.parse(JSON.stringify(get(game)))
      game.undo()
      const {
        history: _hAfterUndo,
  ...
  describe('Redo Functionality', () => {
    it('should redo moves correctly and manage history/future arrays', () => {
      ...
      const {
        history: _hBeforeRedo,
        future: _fBeforeRedo,
        ...stateBeforeExtraRedo
      } = JSON.parse(JSON.stringify(get(game)))
      game.redo()
      const {
        history: _hAfterRedo,
